...
export function ContactWhatsAppCard() {
  return (
    <button
      ...
      className="group flex min-h-14 w-full items-center gap-3 rounded-2xl border border-line bg-white p-3.5 text-left shadow-xs transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md sm:gap-4 sm:p-4"
    >
      ...
      <span className="flex-1">
        ...
        <span className="block text-body-sm text-ink-2">Chat with us instantly</span>
      </span>
