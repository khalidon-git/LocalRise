...
Working instructions for Claude on this repo. Deep detail lives in **`docs/`** (how
...
## Delegate to specialised subagents (`.claude/agents/`)
Prefer routing focused work to the right specialist — it keeps context small, edits
accurate, and lets tasks run in parallel. See `.claude/agents/README.md`.
